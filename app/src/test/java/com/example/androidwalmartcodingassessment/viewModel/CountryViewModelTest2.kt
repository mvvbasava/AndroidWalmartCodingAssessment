...
class CountryViewModelTest2 {
    ...
    fun `fetchCountryList should post LiveData when API call is successful again`(): Unit =
        runBlocking {
            ...
            mockkStatic("com.example.androidwalmartcodingassessment.converters.CountryConverterKt") // Replace with actual package
            ...
            unmockkStatic("com.example.androidwalmartcodingassessment.converters.CountryConverterKt")
